...
public class JuguetronInsert {
		
	static String portal = "juguetron";
	static String cuenta, idProyecto, idCadena;	
	static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(JuguetronInsert.class);
	...
	public static void insertarBD(String cuenta) {
		...
		log.info("INSERT; Se ejecuta Juguetron insert en cuenta: "+cuenta);
		...
		try {
			...
			ResultSet rs = s.executeQuery ("SELECT FechaCreacion AS fecha FROM tempjuguetron GROUP BY FechaCreacion ORDER BY FechaCreacion DESC LIMIT 1 ;");
			rs.next();
        ...
        for (int k = 0; k < oldDates.size(); k++) {
            ...
            try {
                log.info("INSERT: Comienza inserción de portal Juguetron Spinmaster venta diaria");
	...
	public static void readDataJuguetron(String fecha) {
        ...
        try {
            ...
            String[] headerRow = {"id", "fechaCreacion", "fechaCarga", "formato", "idTienda", "tienda", "claveProducto", "producto", "piezas", "ventasMonto", "existencias", "inventarioMonto"};
