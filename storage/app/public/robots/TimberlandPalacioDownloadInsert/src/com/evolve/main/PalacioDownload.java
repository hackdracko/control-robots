...
public class PalacioDownload {
	...
	public static void main(String[] args) {		
        ...
        try {
            ...
            log.info("[-]Termina ejecuciÛn del portal Palacio Cesarfer");
            util.insertLog(cuenta, portal, "Download - Main: Termina ejecuciÛn robot palacio", "success");
        ...
        try {
            ...
            if (iIndPortalEjec == 1) {
                ...
                if (count == 1) {
                    ...
                    boolean success = driver.getPageSource().contains("AutentificaciÛn de usuario fallida");
                    if (success == true) {                        
	...
	public static void readPalacioFile(File file, String path) throws FileNotFoundException, IOException {
        ...
        try {
            ...
            log.info("[-]Generaci√≥n de archivo txt completa");
