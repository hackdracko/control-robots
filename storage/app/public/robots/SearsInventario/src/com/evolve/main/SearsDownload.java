...
public class SearsDownload {
	...
	public static void main(String[] args) {
		...
		try {
			...
			ArrayList<String> oldDates = util.getDatesFromLastReportFileFormatInventarios("ddMMyyyy", fechainicial, fechafinal);
		...
		try {
			if (indPortalEjec == 1) {
				...
				if (success == true) {
                    ...
                    String filePrefix = prop.getProperty(portal+".prefix");
                    String pathFile = "";
                    pathFile = config.getPathFolderData() + portal + "\\inventarios\\" + filePrefix + fechaDownload + ".txt";
					...
					for (String s: elementos) {
	                    ...
	                    driver.findElement(By.name("cmdPiezas")).click();
	    				...
	    				if(checkError == true){
							driver.close();
							TimeUnit.SECONDS.sleep(5);
							System.out.println("Cierro Ventana 1");
							driver.switchTo().window(winHandleBefore3);
							driver.close();
							System.out.println("Cierro Ventana 2");
							TimeUnit.SECONDS.sleep(5);
	    				}else{
	    					System.out.println("Descargando de tienda -->"+s);
		                    Document doc;
	...
	public static void moveFile (String fecha){
		...
		String filePrefix = prop.getProperty(portal + ".prefix");
		String pathFile = config.getPathFolderData() + portal + "\\inventarios\\" + filePrefix + fecha + ".txt";
