...
public class MartiInsert {
		
	static String portal = "marti";
	static String cuenta, idProyecto, idCadena;	
	static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(MartiInsert.class);
	...
	public static void insertarBD(String cuenta) {
		...
		log.info("INSERT; Se ejecuta Marti insert en cuenta: "+cuenta);
		...
		try {
			...
			ResultSet rs = s.executeQuery ("SELECT fechaArchivo AS fecha FROM tempmarti GROUP BY fechaArchivo ORDER BY fechaArchivo DESC LIMIT 1 ;");
        ...
        for (int k = 0; k < oldDates.size(); k++) {
            ...
            try {
                log.info("INSERT: Comienza inserción de portal Marti Underamour venta diaria");
                ...
                log.info("INSERT: Termina insersión de portal Marti Underamour venta diaria"); 
	...
	public static void readDataJuguetron(String fecha) {
        ...
        try {
            ...
            String[] headerRow = {"id", "fecha", "fechaarchivo", "fechacarga", "tienda", "nombre", "idMarti", "descripcion", "categoria", "grupo", "descripcion2", "modelo", "temporada", "marca", "color", "talla", "upc", "ventas", "fechaVenta", "ventasNetas", "precioIva", "ventasPublicoSinIva", "impRebaja", "rebajaPorcentaje"};
            ...
            loadCSVJuguetronCesarfer(urlFile, "tempMarti", true, headerRow, isDoble, fecha);
