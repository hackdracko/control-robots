	...
	public static void insertarBD(String cuenta) {
        ...
        for (int k = 0; k < oldDates.size(); k++) {
            ...
            try {
                ...
                log.info("INSERT: Termina insersión de portal Liverpool Cesarfer venta diaria"); 
                util.insertLog(cuenta, portal, "Insert - insertarBD: Termina el proceso de insersión", "success");
            } catch (Exception e) {
...
//            logger.log(Level.INFO, "FECHA DEL SISTEMA: {0}", fechaSistema);
	...
	public static void insertDataLiverpoolCesarfer(String fecha) throws Exception {
        ...
        try {
            con = connection;
            con.setAutoCommit(false);
            log.info("INSERT: Comienza Inserción de datos Liverpool-Cesarfer");
